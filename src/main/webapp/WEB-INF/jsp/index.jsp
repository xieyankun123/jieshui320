...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<link rel="shortcut icon" href="static/images/logo_small.png" type="image/x-icon" />
		<title>国泰节水自动抄表</title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0" />
		<style type="text/css">
			.bigtitle{height: 75px;line-height: 75px;display: block;float: left;margin-left: 10px;}
			.bigtubiao{width: 40px;display: block;float: left;margin-top:19px;border-radius:50%;}
		</style>
		<base href="<%=basePath%>">
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small >
							<img class="bigtubiao" src="static/images/logo_small.png">
							<!-- <img src="images/logo.png" width="470px"> -->
							<h2 class="bigtitle" >国泰节水后台控制平台</h2>
						</small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
						...
						<ul class="nav nav-list" id="nav_list">
				     		<li class="home">
                  			...
                  			<li>
                    			...
                    			<ul class="submenu">
                    				<li class="home"><a href="javascript:void(0)" name="user/user_list" title="用户列表"  class="iframeurl"><i class="icon-double-angle-right"></i>用户列表</a></li>
								</ul>
				  			</li>
							...
							<%--</li>--%>
							<li><a href="#" class="dropdown-toggle"><i class="icon-laptop"></i><span class="menu-text"> 水表管理 </span><b class="arrow icon-angle-down"></b></a>
								<ul class="submenu">
									<li class="home">
										<a href="javascript:void(0)" name="apartment/apa_list" title="水表列表" class="iframeurl"><i class="icon-double-angle-right"></i>水表列表
										</a>
									</li>
									<%--<li class="home">--%>
										<%--<a href="javascript:void(0)" name="room/house_list" title="房源列表" class="iframeurl"><i class="icon-double-angle-right"></i>房源列表--%>
