...
<div class="page-content clearfix">
 <div class="alert alert-block alert-success">
  ...
  <i class="icon-ok green"></i>欢迎使用<strong class="green">国泰节水自动抄表后台管理<small>(v1.0)</small></strong>
 </div>
 <div class="state-overview clearfix">
                  <div class="col-lg-4 col-sm-6">
                      ...
                      <%--<a href="#" title="租户">--%>
                          ...
                          <div class="value">
                              <h1>250</h1>
                              <p><a href="https://www.qiboyongxun.cn/mg/index">使用人数</a></p>
                          </div>
                          </a>
                      </section>
                  </div>
    ...
    <div class="state-overview clearfix" id="ftCon-Wrapper">
        <div id="ftConw" style="margin: auto;text-align: center;color:#999">
            <p>
                北京启博永讯科技有限公司&nbsp;&nbsp;&nbsp;&nbsp;维修电话：18810625321
