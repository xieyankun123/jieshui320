...
<div class="page-content clearfix">
    ...
    <div class="search_style">
      ...
      <ul class="search_content clearfix">
       <li><label class="l_f"></label><input name="" type="text"  id="sousuo" class="text_add"  placeholder="输入用户名、手机"  style=" width:200px"/></li>
     ...
     <div class="table_menu_list" style="width: 100%!important;">
       <table class="table table-striped table-bordered table-hover" id="sample-table" style="width: 100%!important;">
        ...
        <th style="width:11%">公司</th>
				<!-- <th width="150">邮箱</th> -->
				<th style="width:11%">地址</th>
				<!-- <th width="180">加入时间</th> -->
        <th style="width:7%">水表信息</th>
    ...
    <c:if test="${!empty userList }">
		...
		<tr>
          ...
          <td><a href="<%=basePath%>meter/sdq1?user_telephone=${user.user_telephone}" title="点击查看水表信息" ><img style="width:25px" src="static/images/water.png"></a></td>
            <c:choose>
...
<div class="add_menber" id="add_menber_style" style="display:none">
    ...
    <ul class=" page-content">
     ...
     <label><input name="form-field-radio0" type="radio" class="ace" value="女"><span class="lbl">女</span></label>&nbsp;&nbsp;&nbsp;
        ...
        <li><label class="label_name">人&nbsp;&nbsp;口&nbsp;&nbsp;&nbsp;数：</label><span class="add_name"><input name="人口数" type="text" data-shu='aihao' class="text_add"/></span><div class="prompt r_f"></div></li>
        <%--<li>--%>
...
function adduser(){
    ...
    $.ajax({
        type: "POST",
        url: 'user/add',
        data: {user_name:xingming1,user_telephone:phone1,factory:factory,
...
function member_edit(obj,aihao,youxiang,zhuangtai){
    ...
    var factory=$(obj).parent().parent().find("td").eq(4).html();
...
function upuser(factory){
    ...
    $.ajax({
        type: "POST",
        url: 'user/update',
        data: {user_name:xingming2,user_telephone:phone2,factory:factory,
